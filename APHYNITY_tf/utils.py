...
def convert_tensor(
    x: Union[tf.Tensor, collections.Sequence, collections.Mapping, str, bytes],
    device: Optional[Union[str, tf.device]] = None,
    non_blocking: bool = False,
    ) -> Union[tf.Tensor, collections.Sequence, collections.Mapping, str, bytes]:
...
def apply_to_tensor(
    x: Union[tf.Tensor, collections.Sequence, collections.Mapping, str, bytes], func: Callable
    ) -> Union[tf.Tensor, collections.Sequence, collections.Mapping, str, bytes]:
